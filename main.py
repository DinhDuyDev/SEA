...
def main():
    ...
    Button(WINDOW_WIDTH/2, WINDOW_HEIGHT/2+66, 128, 32, "EXIT GAME", "MENU")
    Button(WINDOW_WIDTH/2, WINDOW_HEIGHT/2+80, 128, 32, "Add Name", "ADDING_NAMES")
    Button(WINDOW_WIDTH/2, WINDOW_HEIGHT/2+114, 128, 32, "Delete Name", "ADDING_NAMES")
    Button(WINDOW_WIDTH/2, WINDOW_HEIGHT/2+148, 128, 32, "Proceed to fight!", "ADDING_NAMES")
